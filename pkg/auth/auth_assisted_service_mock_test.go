...
func (f fakeInventory) DownloadBootFiles(ctx context.Context, params installer.DownloadBootFilesParams) middleware.Responder {
	return installer.NewDownloadBootFilesOK()
}
