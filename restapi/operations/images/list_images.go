...
type ListImagesHandlerFunc func(ListImagesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListImagesHandlerFunc) Handle(params ListImagesParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// ListImagesHandler interface for that can handle valid list images params
type ListImagesHandler interface {
	Handle(ListImagesParams, interface{}) middleware.Responder
}
...
/*ListImages swagger:route GET /clusters/{cluster_id}/images images listImages

Retrieves the list of Discovery ISOs.
