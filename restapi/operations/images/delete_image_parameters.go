...
func (o *DeleteImageParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteImageParams) validateClusterID(formats strfmt.Registry) error {
...
func (o *DeleteImageParams) bindImageID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteImageParams) validateImageID(formats strfmt.Registry) error {
