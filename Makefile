...
deploy-onprem:
	...
	[ -f livecd.iso ] || until curl https://mirror.openshift.com/pub/openshift-v4/dependencies/rhcos/4.6/latest/rhcos-live.x86_64.iso --retry 5 -o livecd.iso; do sleep 1; done
