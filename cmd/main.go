...
import (
	...
	"github.com/openshift/assisted-service/internal/images"
...
func main() {
	...
	expirer := imgexpirer.NewManager(objectHandler, eventsHandler, Options.ImagesConfig.ImageExpirationTime, lead)
