...
func (o *DownloadClusterISOReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewDownloadClusterISOServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *DownloadClusterISOOK) Error() string {
	return fmt.Sprintf("[GET /clusters/{cluster_id}/images/{image_id}/data][%d] downloadClusterISOOK  %+v", 200, o.Payload)
}
...
func (o *DownloadClusterISOBadRequest) Error() string {
	return fmt.Sprintf("[GET /clusters/{cluster_id}/images/{image_id}/data][%d] downloadClusterISOBadRequest  %+v", 400, o.Payload)
}
...
func (o *DownloadClusterISOUnauthorized) Error() string {
	return fmt.Sprintf("[GET /clusters/{cluster_id}/images/{image_id}/data][%d] downloadClusterISOUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DownloadClusterISOForbidden) Error() string {
	return fmt.Sprintf("[GET /clusters/{cluster_id}/images/{image_id}/data][%d] downloadClusterISOForbidden  %+v", 403, o.Payload)
}
...
func (o *DownloadClusterISONotFound) Error() string {
	return fmt.Sprintf("[GET /clusters/{cluster_id}/images/{image_id}/data][%d] downloadClusterISONotFound  %+v", 404, o.Payload)
}
...
func (o *DownloadClusterISOInternalServerError) Error() string {
	return fmt.Sprintf("[GET /clusters/{cluster_id}/images/{image_id}/data][%d] downloadClusterISOInternalServerError  %+v", 500, o.Payload)
}
...
// NewDownloadClusterISOServiceUnavailable creates a DownloadClusterISOServiceUnavailable with default headers values
...
/*DownloadClusterISOServiceUnavailable handles this case with default header values.
...
func (o *DownloadClusterISOServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /clusters/{cluster_id}/images/{image_id}/data][%d] downloadClusterISOServiceUnavailable  %+v", 503, o.Payload)
}

func (o *DownloadClusterISOServiceUnavailable) GetPayload() *models.Error {
	return o.Payload
}

func (o *DownloadClusterISOServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
