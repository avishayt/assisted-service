...
// WithClusterID adds the clusterID to the get image params
func (o *GetImageParams) WithClusterID(clusterID strfmt.UUID) *GetImageParams {
	o.SetClusterID(clusterID)
	return o
}

// SetClusterID adds the clusterId to the get image params
func (o *GetImageParams) SetClusterID(clusterID strfmt.UUID) {
